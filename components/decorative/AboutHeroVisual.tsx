...
export default function AboutHeroVisual() {
  ...
  return (
    <div className="relative w-full max-w-[500px] h-[440px] sm:h-[460px] mx-auto flex items-center justify-center select-none">
      ...
      <div className="absolute inset-0 m-auto w-72 h-72 rounded-full bg-gradient-to-tr from-amber-600/20 via-amber-500/15 to-yellow-500/10 blur-3xl pointer-events-none -z-10" />
      ...
      >
        <div className="w-7 h-7 rounded-xl bg-[#F5BA27]/10 dark:bg-[#F5BA27]/20 flex items-center justify-center text-[#F5BA27] dark:text-[#F5BA27]">
      ...
      <motion.div
        ...
        className="relative w-44 h-44 sm:w-48 sm:h-48 rounded-[2.5rem] glass-glossy z-10 flex flex-col items-center justify-center shadow-[0_24px_50px_rgba(0,0,0,0.12),0_0_40px_rgba(245, 186, 39,0.18),inset_0_2px_4px_rgba(255,255,255,0.8)] border border-white/40 dark:border-white/20 backdrop-blur-2xl"
      >
        ...
        <div className="absolute bottom-3 inset-x-6 h-3 rounded-full bg-[#F5BA27]/10 dark:bg-[#F5BA27]/20 blur-sm pointer-events-none" />
      </motion.div>
    </div>
  );
}
